...
class FileStat
 ...
 @@ftypes = [
  ...
  def initialize(filename,session)
    ...
    data = data.split(",")
    @stathash = Hash.new
    @stathash['st_dev'] = data[0]
    @stathash['st_ino'] = data[1]
    @stathash['st_nlink'] = data[2]
    @stathash['st_uid'] = data[3]
    @stathash['st_gid'] = data[4]
    @stathash['st_rdev'] = data[5]
    @stathash['st_size'] = data[6]
    @stathash['st_blksize'] = data[7]
    @stathash['st_blocks'] = data[8]
    @stathash['st_atime'] = data[9]
    @stathash['st_mtime'] = data[10]
    @stathash['st_ctime'] = data[11]
